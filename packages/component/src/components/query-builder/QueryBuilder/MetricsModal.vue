...
<style scoped>
  .dp-metrics-modal :deep(.ant-modal-body) {
    padding: 16px;
  }
  ...
  /* 自定义 Table 样式 */
  .dp-metrics-modal__table :deep(.ant-table) {
    font-size: 13px;
  }

  .dp-metrics-modal__table :deep(.ant-table-thead > tr > th) {
    background: #fafafa;
    font-weight: 600;
    font-size: 12px;
  }

  .dp-metrics-modal__table :deep(.ant-table-tbody > tr:hover > td) {
    background: #f5f5f5;
  }

  .dp-metrics-modal__table :deep(.ant-tag) {
    font-size: 11px;
    margin: 0;
  }

  .dp-metrics-modal__table :deep(.ant-btn-link) {
    padding: 0;
  }
</style>
