...
<template>
  <div
    ...
    :class="[bem(), bem(options.position || 'bottom'), bem(options.size || 'medium'), bem({ mode: effectiveMode })]"
  >
    <component
      :is="legendComponent"
      :items="items"
...
<script setup lang="ts">
  ...
  import type { LegendItem, LegendOptions, LegendSelection } from '@grafana-fast/types/legend';
