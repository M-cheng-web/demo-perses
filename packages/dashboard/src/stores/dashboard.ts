...
function countDashboardStats(d: DashboardContent): { groupCount: number; panelCount: number } {
...
function sanitizeDashboardContent(input: DashboardContent): DashboardContent {
