...
<style scoped>
  .dp-query-patterns-modal :deep(.ant-modal-body) {
    padding: 16px;
  }
  ...
  .dp-query-patterns-modal__card :deep(.ant-card-head) {
    background: #fafafa;
    padding: 10px 16px;
    min-height: auto;
  }

  .dp-query-patterns-modal__card :deep(.ant-card-head-title) {
    font-weight: 600;
    font-size: 14px;
    padding: 0;
  }

  .dp-query-patterns-modal__card :deep(.ant-card-body) {
    padding: 12px;
  }
